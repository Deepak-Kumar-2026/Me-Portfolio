...
export default function About() {
  return (
    <div className="relative overflow-hidden min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-emerald-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="text-center mb-28">
          ...
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-cyan-100 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl shadow-sm mb-8">
        ...
        <section className="mb-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            {/* FRONTEND */}
            <div className="group rounded-[32px] border border-white bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500">

              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-100 to-blue-100 flex items-center justify-center mb-6 shadow-sm">
            ...
            <div className="group rounded-[32px] border border-white bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-100 to-cyan-100 flex items-center justify-center mb-6 shadow-sm">
            ...
            <div className="group rounded-[32px] border border-white bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center mb-6 shadow-sm">
        ...
        <section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="rounded-[36px] border border-white bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl p-6 md:p-10 shadow-2xl">
...
/>
              ...
              <div className="text-center">
                ...
                <p className="text-cyan-600 font-semibold text-lg md:text-xl mb-6">
                  ...
                  I.K. Gujral Punjab Technical University (IKGPTU), Jalandhar • 2022 - 2026
                ...
                <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
                  ...
                  software engineering, scalable backend systems, and modern frontend technologies.

                  <br />
                  <br />

                  Actively building real-world MERN stack projects while continuously exploring
                  Data Science, problem-solving, and modern development workflows.
